...
#                                                     #
# https://www.paterva.com/web6/documentation/developer-local.php #
##################################################################
import sys
...
class MaltegoTransform(object):
    ...
    def addEntity(self,enType,enValue, fieldName=None, value=None):
        me = MaltegoEntity(enType,enValue)
        if fieldName is not None and value is not None:
            me.addAdditionalFields(fieldName=fieldName, displayName='Field Name', value=value)
